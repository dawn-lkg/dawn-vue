<template>
  <div class="navbar-cp-container">
    <div class="left">
      <div class="hidden-bt">
        <SvgIcon @click="switchShowLogo" :style="'width:20px;height:20px;'"
      ...
      <div class="path-list-container">
        <el-breadcrumb separator="">
          ...
          <el-breadcrumb-item v-for="item, index in dataContainer.breadcrumbList" :key="`${index}--${item.path}`" :to="item.path ? {
          path: item.path,
        } : ''" :class="{
          'has-path': !!item.path,
        }">
    ...
    <div class="right">
      ...
      <div ref="RightOptionRef" :class="{
        ...
        <div v-if="dataContainer.show_1" class="bt-list-container">
          <div class="item">
            <router-link to="/main/mine/info">
              <SvgIcon :style="'width:16px;height:16px;'" name="svg:user-fill.svg"></SvgIcon>
              个人中心
            </router-link>
          </div>
          <div class="item">
            <router-link to="/main/mine/info-password">
              <SvgIcon :style="'width:16px;height:16px;'" name="svg:supervise.svg"></SvgIcon>
              密码修改
            </router-link>
          </div>
          <div class="logout-bt" @click.stop="onLogout">
            <SvgIcon :style="'width:16px;height:16px;color:#f56c6c;'" name="svg:poweroff.svg"></SvgIcon>
            退出登录
          </div>
        </div>
      </div>
    ...
    <div class="search-container">
      <div @click="addNewPage" class="container">
        <div class="left">
          <SvgIcon :style="'width:17px;height:17px;margin-right:10px;'" name="svg:search-bt.svg"></SvgIcon>
          搜索目录
        </div>
        <div class="right">
          Alt S
