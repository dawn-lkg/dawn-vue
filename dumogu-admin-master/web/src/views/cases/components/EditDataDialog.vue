        ...
        <el-row :gutter="0">
          ...
          <el-col :span="24" :xs="6">
            <el-form-item label="网页链接" prop="url">
              <el-input v-model="dataContainer.form.url" placeholder="请输入" :disabled="configData.isShow" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="24" :xs="6">
            <el-form-item label="简介">
              <el-input style="width:100%;" type="textarea" v-model="dataContainer.form.content"
  ...
  setup() {
    ...
    function handleSubmit() {
      ...
      FormElRef.value.validate((valid, e) => {
        ...
        if (!valid) return;
        weblinkApi[configData.isUpdate ? 'updateData' : 'saveData'](dataContainer.form).then(res => {
          otherDataContainer.castParams = {
            name: '数据保存成功了，向外部通知',
          };
