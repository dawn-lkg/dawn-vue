<template>
  <div class="page-container main-view">
    <el-row :gutter="0" class="page-query-box">
      <DifinCollapse :show="dataContainer.showSearch" :showBt="true"
            ...
            <el-row :gutter="0">
              <el-col class="anchor-point-target" :span="6" :xs="6">
                <el-form-item label="用户名称" prop="username">
                  <el-input v-model="dataContainer.form.username" placeholder="请输入" clearable @clear="handleQuery"
              ...
              <el-col :span="6" :xs="6">
                <el-form-item label="数据编号" prop="id">
                  <el-input v-model="dataContainer.form.id" placeholder="请输入" clearable @clear="handleQuery"
                    @keyup.enter="handleQuery" />
                </el-form-item>
              </el-col>
              <el-col :span="6" :xs="6">
                <el-form-item label="手机号码" prop="phone">
                  <el-input v-model="dataContainer.form.phone" placeholder="请输入" clearable @clear="handleQuery"
                    @keyup.enter="handleQuery" />
                </el-form-item>
              </el-col>
              <el-col :span="6" :xs="6">
                <el-form-item label="可选择" prop="disabled">
                  <el-select style="width:100%;" v-model="dataContainer.form.disabled" placeholder="请选择" clearable
                    @clear="handleQuery" @change="handleQuery">
                    <el-option v-for="item in dataContainer.optionList" :key="item.id" :label="item.label"
              ...
              <el-col :span="6" :xs="6">
                <el-form-item label="邮箱" prop="email">
                  <el-input v-model="dataContainer.form.email" placeholder="请输入" clearable @clear="handleQuery"
                    @keyup.enter="handleQuery" />
                </el-form-item>
              </el-col>
              <el-col :span="6" :xs="6">
    ...
    <div class="table-box content-container page-content-box">
      <div class="top-container">
        <div class="left">
          <el-button v-if="hasPermi(['yx:apply:apply'])" type="primary" @click="handleAdd">
            新增
          </el-button>
          <el-button plain type="primary" @click="handleExport">
            导出
          </el-button>
          <el-button plain type="danger" v-if="dataContainer.currentRows.length > 0"
      ...
      <div class="table-container">
        <el-table v-loading="dataContainer.loading" :data="dataContainer.list" border @cell-dblclick="handleCopyVale"
          @sort-change="handleSortChange" :span-method="arraySpanMethod" :summary-method="getSummaries" show-summary
          height="100%">
          <el-table-column label="多选组件" align="center" width="60" fixed="left" class-name="small-padding fixed-width">
            <template #header>
              <el-checkbox style="height: fit-content;" v-model="dataContainer.checked__" @change="e => {
      changeAllCheck(e);
      handleSelectionChange(dataContainer.list.filter(e => e.checked__));
    }" label="" size="large" />
            </template>
            <template #default="scope">
              <el-checkbox v-model="scope.row.checked__" :disabled="isDisabled(scope.row)" @change="() => {
      handleSelectionChange(dataContainer.list.filter(e => e.checked__));
    }" label="" size="large" />
            </template>
          </el-table-column>
          <el-table-column type="index" align="center" label="序号" width="60" fixed="left" />
          <el-table-column label="部门" show-overflow-tooltip align="center" min-width="170" prop="department"
            sortable="custom" :sort-orders="['descending', 'ascending']" />
          <el-table-column label="性别" show-overflow-tooltip align="center" prop="sex" min-width="250" sortable="custom"
            :sort-orders="['descending', 'ascending']">
            <template #default="scope">
              <DictTags :options="dataContainer.optionList_1" :value="scope.row.sex" valueKey="value" labelKey="label">
              </DictTags>
            </template>
          </el-table-column>
          <el-table-column label="工资" show-overflow-tooltip align="center" min-width="150" prop="money"
            sortable="custom" :sort-orders="['descending', 'ascending']" />
          <el-table-column label="用户名称" show-overflow-tooltip align="center" min-width="170" prop="username"
            sortable="custom" :sort-orders="['descending', 'ascending']" />
          <el-table-column label="昵称" show-overflow-tooltip align="center" prop="nickname" min-width="150"
            sortable="custom" :sort-orders="['descending', 'ascending']" />
          <el-table-column label="数据编号" show-overflow-tooltip align="center" prop="id" min-width="150" sortable="custom"
            :sort-orders="['descending', 'ascending']" />
          <el-table-column label="手机号码" show-overflow-tooltip align="center" prop="phone" min-width="150"
            sortable="custom" :sort-orders="['descending', 'ascending']" />
          <el-table-column label="可选择" show-overflow-tooltip align="center" prop="disabled" min-width="150"
            sortable="custom" :sort-orders="['descending', 'ascending']">
            <template #default="scope">
              <DictTags :options="dataContainer.optionList" :value="scope.row.disabled" valueKey="value"
                labelKey="label"></DictTags>
            </template>
          </el-table-column>
          <el-table-column label="邮箱" show-overflow-tooltip align="center" prop="email" min-width="150"
            sortable="custom" :sort-orders="['descending', 'ascending']" />
