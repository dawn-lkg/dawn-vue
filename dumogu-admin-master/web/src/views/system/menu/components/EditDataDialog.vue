        ...
        <el-row :gutter="0">
          ...
          <el-col :span="24">
            <el-form-item label="上级菜单" prop="parentId">
              <el-tree-select style="width:100%;" v-model="dataContainer.form.parentId" placeholder="请选择"
                :disabled="configData.isShow" clearable :data="dataContainer.menuList" check-strictly
                :render-after-expand="false" show-checkbox :check-on-click-node="true" value-key="id" :props="{
    children: 'childs',
    label: 'title',
    value: 'id',
    disabled(data) {
      return data.treeLevels >= dataContainer.form.treeLevels;
          ...
          <el-col :span="12" :xs="6">
            <el-form-item label="菜单名称" prop="title">
              <el-input v-model="dataContainer.form.title" placeholder="请输入" :disabled="configData.isShow" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12" :xs="6">
            <el-form-item label="菜单简介" prop="content">
              <el-input v-model="dataContainer.form.content" placeholder="请输入" :disabled="configData.isShow"
                clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12" :xs="6">
            <el-form-item label="路由名称(跳转页面)" prop="name">
              <el-select placeholder="请选择" style="width:100%;" :disabled="configData.isShow"
                v-model="dataContainer.form.name" clearable>
                <el-option v-for="item, index in dataContainer.sysMeluList" :key="index" :label="item.name"
                  :value="item.name" />
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="12" :xs="6">
            <el-form-item label="路由地址/链接" prop="path">
              <el-input v-model="dataContainer.form.path" placeholder="请输入" :disabled="configData.isShow" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12" :xs="6">
            <el-form-item label="排序" prop="sort">
              <el-input-number style="width:100%;" v-model="dataContainer.form.sort" :min="1" :max="999"
                controls-position="right" :disabled="configData.isShow" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12" :xs="6">
            <el-form-item label="图标" prop="iconName">
              <IconSlect :name="dataContainer.form.iconName" :isShow="configData.isShow" @change="e => {
    dataContainer.form.iconName = e;
          ...
          <el-col :span="12" :xs="6">
            <el-form-item label="是否缓存" prop="isCache">
              <el-switch v-model="dataContainer.form.isCache" :disabled="configData.isShow" active-text="是"
                inactive-text="否" />
            </el-form-item>
          </el-col>
          <el-col :span="12" :xs="6">
            <el-form-item label="是否隐藏" prop="hidden">
              <el-switch v-model="dataContainer.form.hidden" :disabled="configData.isShow" active-text="是"
                inactive-text="否" />
            </el-form-item>
          </el-col>
          <el-col :span="12" :xs="6">
            <el-form-item label="是否外部链接" prop="isLink">
              <el-switch v-model="dataContainer.form.isLink" :disabled="configData.isShow" active-text="是"
                inactive-text="否" />
            </el-form-item>
          </el-col>
          <el-col :span="12" :xs="6">
            <el-form-item label="是否标签页固定" prop="fixed">
              <el-switch v-model="dataContainer.form.fixed" :disabled="configData.isShow" active-text="是"
                inactive-text="否" />
            </el-form-item>
          </el-col>
        </el-row>
