<template>
  <div class="page-container mine-view">
    <div class="container">
      <el-form :model="dataContainer.form" ref="FormElRef" :inline="false" :rules="dataContainer.rules"
        label-width="120px">
        <el-row :gutter="0">
          <el-col :span="24">
            <el-form-item label="原密码" prop="oldPassword">
              <el-input v-model="dataContainer.form.oldPassword" type="password" placeholder="请输入" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="新密码" prop="newPassword">
              <el-input v-model="dataContainer.form.newPassword" type="password" placeholder="请输入" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="重新输入新密码" prop="newPassword_1">
              <el-input v-model="dataContainer.form.newPassword_1" type="password" placeholder="请输入" clearable />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
  ...
  setup() {
    ...
    function handleSubmit() {
      ...
      FormElRef.value.validate((valid, e) => {
        ...
        if (!valid) return;
        UserApi.updatePassword(dataContainer.form).then(async res => {
          await getUserData();
