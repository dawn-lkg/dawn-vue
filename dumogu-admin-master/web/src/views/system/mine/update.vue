<template>
  <div class="page-container mine-view">
    <div class="container img-container">
      <el-form style="width:100%;" :model="dataContainer.form" :inline="false" label-width="120px">
        <el-row :gutter="0">
          <el-col :span="24">
            <el-form-item label="用户头像" prop="">
              <div>
                <div class="img-upload">
                  <UploadSingleImg ref="UploadSingleImgRef" :imgUrl="dataContainer.imgUrl_3"
                    :showCancelBt="!!dataContainer.imgUrl_3" :maxSize="1024 * 1024 * 7" :minSize="1024 * 7"
                    :needAccept="'image/png,image/jpeg'" :autoUpload="false" :showChooseBt="false"
                    :uploadApi="'/user/avatar'" @onSuccess="handleUploadSuccess" @onFail="handleUploadFail"
                    @onCancel="handleUploadCancel"></UploadSingleImg>
                  <div @click="changeImg" class="bt">
                    <SvgIcon :style="'width: 25px;min-width:25px;height: 25px;'" name="svg:upload.svg"></SvgIcon>
                  </div>
                </div>
                <el-button style="margin-top:15px;" type="primary" @click="handleUpload">
                  确认修改新头像
                </el-button>
              </div>
            </el-form-item>
    ...
    <div class="container">
      <el-form style="width:100%;" :model="dataContainer.form" ref="FormElRef" :inline="false"
        :rules="dataContainer.rules" label-width="120px">
        <el-row :gutter="0">
          <el-col :span="24">
            <el-form-item label="用户昵称" prop="nickname">
              <el-input v-model="dataContainer.form.nickname" placeholder="请输入" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="手机号码" prop="newPassword">
              <el-input v-model="dataContainer.form.phonenumber" placeholder="请输入" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="邮箱" prop="newPassword_1">
              <el-input v-model="dataContainer.form.email" placeholder="请输入" clearable />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
  ...
  setup() {
    ...
    function handleSubmit() {
      ...
      FormElRef.value.validate((valid, e) => {
        ...
        if (!valid) return;
        /** 向后端提交 */
        UserApi.updateUserInfo(dataContainer.form).then(async res => {
          await getUserData();
    ...
    function changeImg() {
      ...
      ChangeImgDialogRef.value.initData(true, {
    ...
    function handleUpload() {
      ...
      UploadSingleImgRef.value.handleUpload(otherDataContainer.imgFile).then(() => {
        /** 此处可以想后端提交保存的信息 */
      }).catch(() => {
        return;
      });
