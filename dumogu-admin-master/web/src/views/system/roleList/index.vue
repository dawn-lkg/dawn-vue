          ...
          <el-row :gutter="0">
            <el-col :span="6" :xs="6">
              <el-form-item label="角色名称" prop="roleName">
                <el-input v-model="dataContainer.form.roleName" placeholder="请输入" clearable @clear="handleQuery"
                  @keyup.enter="handleQuery" />
              </el-form-item>
            </el-col>
            <el-col :span="6" :xs="6">
              <el-form-item label="角色标识" prop="roleKey">
                <el-input v-model="dataContainer.form.roleKey" placeholder="请输入" clearable @clear="handleQuery"
                  @keyup.enter="handleQuery" />
              </el-form-item>
            </el-col>
            <el-col :span="6" :xs="6">
    ...
    <div class="table-box content-container page-content-box">
      ...
      <div class="table-container">
        <el-table v-loading="dataContainer.loading" :data="dataContainer.list" border @cell-dblclick="handleCopyVale"
          ...
          <el-table-column label="角色名称" show-overflow-tooltip align="center" min-width="170" prop="roleName" />
          <el-table-column label="角色标识" show-overflow-tooltip align="center" prop="roleKey" min-width="150" />
          <el-table-column label="排序" show-overflow-tooltip align="center" prop="roleSort" width="100" />
          <el-table-column label="角色状态" show-overflow-tooltip align="center" prop="status" width="100">
          ...
          <el-table-column label="角色描述" show-overflow-tooltip align="center" prop="remark" min-width="150" />
...
export default defineComponent({
  ...
  setup() {
    ...
    getDataList();
    /**获取菜单列表 */
    const getMenuList = debounceFn(function() {
      dataContainer.loading = true;
    ...
    function handleAdd() {
      ...
      EditDataDialogRef.value.initData(true, {
        ...
        afterTitle: ' - 添加',
        isUpdate: false,
        treeData: dataContainer.menuList
      }).then(() => {
        getDataList();
      }).catch(() => {
    ...
    function handleDelete(row) {
      confirm('确认删除该数据？').then(() => {
        dataContainer.loading = true;
        roleApi.removeData(row.roleId).then(() => {
          getDataList();
        }).catch(() => {
          return;
        }).finally(() => {
