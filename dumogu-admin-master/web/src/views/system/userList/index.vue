          ...
          <el-row :gutter="0">
            ...
            <el-col :span="6" :xs="6">
              <el-form-item label="角色标识" prop="sign">
                <el-input v-model="dataContainer.form.sign" placeholder="请输入" clearable @clear="handleQuery"
                  @keyup.enter="handleQuery" />
              </el-form-item>
            </el-col>
            <el-col :span="6" :xs="6">
    ...
    <div class="table-box content-container page-content-box">
      <div class="top-container">
        <div class="left">
          ...
          <el-button plain type="danger" v-if="dataContainer.currDataList.length > 0"
      ...
      <div class="table-container">
        <el-table v-loading="dataContainer.loading" :data="dataContainer.list" border @cell-dblclick="handleCopyVale"
          ...
          <el-table-column label="用户名称" show-overflow-tooltip align="center" min-width="170" prop="nickname" />
          <el-table-column label="用户账号" show-overflow-tooltip align="center" min-width="170" prop="username" />
          <el-table-column label="角色标识" show-overflow-tooltip align="center" prop="roleNames" min-width="150" />
          <el-table-column label="手机号" show-overflow-tooltip align="center" prop="phonenumber" width="150" />
          <el-table-column label="邮箱" show-overflow-tooltip align="center" prop="email" width="150" />
          <el-table-column label="用户状态" show-overflow-tooltip align="center" prop="status" width="100">
...
export default defineComponent({
  ...
  setup() {
    ...
    const getDataList = debounceFn(function() {
      ...
      userApi.getDataPage({ ...dataContainer.params, ...dataContainer.form }).then(res => {
    ...
    function handleDelete(row) {
      confirm('确认删除该数据？').then(() => {
        dataContainer.loading = true;
        userApi.removeData(row.userId).then((res) => {
          getDataList();
    ...
    function getRoleList() {
      roleApi.getDataList().then(res => {
        roleList.value = res.data.map(d => ({
          value: d.roleId,
          label: d.roleName
        }))
      })
